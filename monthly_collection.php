                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            ...
                            <li><a href="#">Current Month Due</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <?php
                            $n=1;
                            $query=mysqli_query($con,"SELECT * FROM billing WHERE paid > 0 AND (DATE_FORMAT(service_date,'%m-%Y')=DATE_FORMAT(NOW(),'%m-%Y') AND DATE_FORMAT(payment_date,'%m-%Y')=DATE_FORMAT(NOW(),'%m-%Y')) ORDER BY id DESC");
